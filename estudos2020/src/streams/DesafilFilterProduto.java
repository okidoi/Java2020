...
public class DesafilFilterProduto {
	...
	public static void main(String[] args) {
		...
		produtos.stream()
			...
			.forEach(DesafilFilterProduto::gravaNoBanco);
				
	}
	
	
	private static void gravaNoBanco(String regChamadaPromocional) {
		
		//Para cada registro do forEach ele vai entrar aqui;
		
		System.out.println("Gravando no Banco de dados...");
		
		System.out.println(regChamadaPromocional);
